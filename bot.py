...
class PropagandaBot(commands.Bot):
    ...
    async def register_commands(self):
        ...
        @self.tree.command(name="set_discord_token", description="Set the Discord bot token (use in DM only for security)")
        ...
        @self.tree.command(name="help", description="Get information about available commands")
        async def help(self, interaction: discord.Interaction):
            """Display help information about the bot."""
            embed = discord.Embed(title="Propaganda Poster Bot - Help", description="I am a bot that generates propaganda-style posters using AI. Here are my commands:", color=discord.Color.blue())
        ...
        @self.tree.command(name="play", description="Play a random song from the configured playlist")
        ...
        @self.tree.command(name="play_url", description="Play a specific YouTube URL")
        ...
        @self.tree.command(name="add_to_playlist", description="Add a YouTube URL to the playlist")
        ...
        try:
            ...
            app_id = self.user.id
            permissions = discord.Permissions(send_messages=True, embed_links=True, attach_files=True, manage_webhooks=True)
            invite_url = discord.utils.oauth_url(app_id, permissions=permissions, scopes=("bot", "applications.commands"))
